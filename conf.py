...
BLOG_AUTHOR = "Sean Carrell"  # (translatable)
BLOG_TITLE = "Exploring Mathematics"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://www.seancarrell.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.seancarrell.com/"
BLOG_EMAIL = "s.r.carrell@gmail.com"
BLOG_DESCRIPTION = "A personal blog exploring mathematics"  # (translatable)
